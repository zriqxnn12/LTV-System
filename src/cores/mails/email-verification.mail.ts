...
export const emailVerificationMailHtml = (user: User, url: string) => {
  ...
  <v:fill type="frame" src="https://modulescomposer.s3.us-east-2.amazonaws.com/simpli/header-2.jpg" color="#F4F4F4">
  <v:textbox style="mso-fit-shape-to-text:true;" inset="0,0,0,0"><![endif]-->
  <div>
  <!-- simpli-header-bg-image -->
  <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
    <tbody><tr>
      <td align="center" background="https://modulescomposer.s3.us-east-2.amazonaws.com/simpli/header-2.jpg" style="background-size:cover;background-position:center top;border-radius:36px;">
  <!-- Content -->
    ...
    <tbody><tr>
      <td align="center" bgcolor="#FFFFFF" style="border-radius:0 0 36px 36px;border-bottom:solid 6px #DDDDDD;">
        ...
        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row container-padding" width="520" style="width:520px;max-width:520px;">
          ...
          <tr>
            <td class="center-text" align="center" style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:42px;line-height:54px;font-weight:700;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;">
          ...
          <tr>
            <td class="center-text" align="center" style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:16px;line-height:26px;font-weight:300;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;">
                  ...
                  <div style="margin: 0px; padding: 0px;">
                    Click following button to verify your email.
                  </div>
                ...
                <table border="0" cellpadding="0" cellspacing="0" align="center">
                  <tr>
                    ...
                    <![endif]-->
                        ...
                        <a href="${url}" target="_blank" style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:16px;line-height:20px;font-weight:700;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;padding:15px 35px 15px 35px;display:inline-block;"><span>SUBSCRIBE NOW</span></a>
